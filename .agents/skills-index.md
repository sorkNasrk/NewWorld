...
| Build, UBT, Automation, Data Validation | .codex/skills/project/ue58-build-test-runner/SKILL.md | references/validation-matrix.md; Tools/AI/check_ai_readiness.py |
...
| UE MCP and editor automation safety | .codex/skills/project/ue58-mcp-editor-automation/SKILL.md | references/mcp-operation-review.md; Docs/Planning/MCP_OPERATION_AUDIT.md; Tools/MCP/check_mcp_readiness.py; Tools/MCP/import_static_mesh_via_ue_mcp.py |
| Blender MCP modeling, cleanup, screenshots, export | .codex/skills/project/ue58-blender-mcp-asset/SKILL.md | references/blender-mcp-decision-tree.md; Tools/MCP/start_blender_mcp_session.py; Tools/Assets/export_blender_static_mesh_fbx.py |
