...
- StaticMesh FBX export script: Tools/Assets/export_blender_static_mesh_fbx.ps1.
...
7. Use Tools/Assets/export_blender_static_mesh_fbx.ps1 for static mesh FBX export to UE staging. Pass explicit object names for render meshes and UCX collision meshes whenever possible.
...
- Run Tools/Assets/export_blender_static_mesh_fbx.ps1 for staged static mesh FBX export; it defaults to Content/NewWorld/AIWork and uses UE centimeter scale.
