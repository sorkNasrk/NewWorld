...
- UE ModelContextProtocol is enabled for Editor targets only and must be manually started with Tools/MCP/start_ue_mcp_editor.py.
...
- For UE MCP static mesh imports, use Tools/MCP/import_static_mesh_via_ue_mcp.py after the editor MCP server is reachable.
...
- Run Tools/MCP/check_mcp_readiness.py after config or plugin changes.
- Run Tools/AI/check_ai_readiness.py after project workflow changes.
